...
# Looped through all the rows and, on a random row, flipped a coin.
# during the coin flip, if is it turn out to be one (true), then, 
# just added a pattern to my data in a way that the five of the columns 
...
# little bit more in red color which means they have a lower value. it is 
# because some of the rows have a mean of three in the right hand side, and 
...
# Let's take a closer look at the patters in rows and columns by looking at 
# the marginal means of the rows and columns.
